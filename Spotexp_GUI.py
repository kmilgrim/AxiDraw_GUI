...
class Ui_SpottingExp(QMainWindow):
    ...
    def runSpotter(self):
        ...
        self.ad.options.pen_delay_down = penDelayDown_2
        self.ad.options.pen_delay_up = penDelayUp_2

        makeRow(self)

        self.ad.options.pen_delay_down = penDelayDown_3
        self.ad.options.pen_delay_up = penDelayUp_3
